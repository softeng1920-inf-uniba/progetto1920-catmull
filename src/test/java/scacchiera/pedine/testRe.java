...
class ReTest {
	...
	posizioneInizialeTorreDxBianco = Scacchiera.getCella(coordXinizialeTorreDxBianco, coordYinizialeTorreDxBianco);
	posizioneInizialeTorreSxBianco = Scacchiera.getCella(coordXinizialeTorreSxBianco, coordYinizialeTorreSxBianco);

	posizioneInizialeTorreDxNera = Scacchiera.getCella(coordXinizialeTorreDxNero, coordYinizialeTorreDxNero);
	posizioneInizialeTorreSxNera  = Scacchiera.getCella(coordXinizialeTorreSxNero, coordYinizialeTorreSxNero);
	
	posizioneInizialeReBianco 	= Scacchiera.getCella(coordXinizialeReBianco, coordYinizialeReBianco);
	posizioneInizialeReNero 	= Scacchiera.getCella(coordXinizialeReNero, coordYinizialeReNero);
	Turno.newTurno();
	...
	Cella cellaReBianco = Scacchiera.getCella(coordXinizialeReBianco, coordYinizialeReBianco);
	
	Cella cellaPedoneNero = Scacchiera.getCella(coordXinizialeReBianco, coordYinizialeReBianco - 1);
	...
	Cella cellaReBianco = Scacchiera.getCella(coordXinizialeReBianco, coordYinizialeReBianco - 1);
	cellaReBianco.rimuoviPezzoCorrente(); // In precedenza c'era un pedone
	cellaReBianco.aggiungiPezzo(new Re(Colore.bianco));
	
	Cella cellaPedoneNero = Scacchiera.getCella(coordXinizialeReBianco, coordYinizialeReBianco);
	cellaPedoneNero.rimuoviPezzoCorrente();
	cellaPedoneNero.aggiungiPezzo(new Pedone(Colore.nero));
	...
	Cella cellaPedoneNero = Scacchiera.getCella(coordXinizialeReNero + 1, coordYinizialeReBianco);
	cellaPedoneNero.rimuoviPezzoCorrente();
	cellaPedoneNero.aggiungiPezzo(new Pedone(Colore.nero));
	Re rB = (Re) Scacchiera.getCella(coordXinizialeReNero, coordYinizialeReBianco).getPezzoCorrente();
	...
	Cella cellaPedoneNero = Scacchiera.getCella(coordXinizialeReNero + 1, coordYinizialeReBianco - 1);
	cellaPedoneNero.rimuoviPezzoCorrente();
	cellaPedoneNero.aggiungiPezzo(new Pedone(Colore.nero));
	Re rB = (Re) Scacchiera.getCella(coordXinizialeReNero, coordYinizialeReBianco).getPezzoCorrente();
	...
	Cella cellaReBianco = Scacchiera.getCella(coordXinizialeReNero - 1, coordYinizialeReBianco - 1);
	cellaReBianco.rimuoviPezzoCorrente();
	cellaReBianco.aggiungiPezzo(new Re(Colore.bianco));
	
	Cella cellaPedoneNero = Scacchiera.getCella(coordXinizialeReNero, coordYinizialeReBianco);
	cellaPedoneNero.rimuoviPezzoCorrente();
	cellaPedoneNero.aggiungiPezzo(new Pedone(Colore.nero));
	Re rB = (Re) Scacchiera.getCella(coordXinizialeReNero - 1, coordYinizialeReBianco - 1).getPezzoCorrente();
	 ...
	 */
   	...
   	Cella cellaReBianco = Scacchiera.getCella(coordXinizialeReNero, coordYinizialeReBianco - 1);
   	cellaReBianco.rimuoviPezzoCorrente();
	...
	Controller.mossaScacchi("e4");
		
	Cella cella_c8 = Scacchiera.getCella(terzaColonna, ottavaTraversa);
	Cella cella_a6 = Scacchiera.getCella(primaColonna, sestaTraversa);
	Scacchiera.scambiaCella(cella_c8, cella_a6);
	
   	assertFalse(((Re) posizioneInizialeReBianco.getPezzoCorrente())
   		.isMossaValida(posizioneInizialeReBianco, Scacchiera.getCella(coordXinizialeReBianco, coordYinizialeReBianco - 1)));
	...
	Cella cellaCorrettaDestinazioneReBiancoArroccoLungo = Scacchiera.getCella(secondaColonna, primaTraversa);
	
	final int terzaColonna = 2;
	Cella cellaCorrettaDestinazioneTorreBiancoArroccoLungo = Scacchiera.getCella(terzaColonna, primaTraversa);
	assertFalse(
	...
	final int primaTraversa = 7;
	Cella cellaCorrettaDestinazioneReBiancoArroccoCorto = Scacchiera.getCella(settimaColonna, primaTraversa);
	
	final int sestaColonna = 5;
	Cella cellaCorrettaDestinazioneTorreBiancoArroccoCorto = Scacchiera.getCella(sestaColonna, primaTraversa);
	...
	Controller.mossaScacchi("Re2");
	
	storicoMosse.add("e1 e2");
	storicoMosse.add("a0 a0"); // Aggiungo una mossa fittizia fatta dal nero per non alterare l'algoritmo
	Controller.mossaScacchi("Re1");
	storicoMosse.add("e2 e1");
	storicoMosse.add("a0 a0");
	
	
	// Rimuovo l'alfiere in f1
	Scacchiera.getCella(coordXinizialeReBianco + 1, coordYinizialeReBianco).rimuoviPezzoCorrente();
	
	// Rimuovo il cavallo in g1
	Scacchiera.getCella(coordXinizialeReBianco + 2, coordYinizialeReBianco).rimuoviPezzoCorrente();
	
	Cella cellaCorrettaDestinazioneReBiancoArroccoCorto = Scacchiera.getCella(settimaColonna, primaTraversa);
	Cella cellaCorrettaDestinazioneTorreBiancaArroccoCorto = Scacchiera.getCella(sestaColonna, primaTraversa);
	assertFalse(
	...
	Scacchiera.getCella(coordXinizialeReNero + 1, coordYinizialeReNero).rimuoviPezzoCorrente();
	
	// Rimuovo il cavallo in g8
	Scacchiera.getCella(coordXinizialeReNero + 2, coordYinizialeReNero).rimuoviPezzoCorrente();
	
	Cella cellaCorrettaDestinazioneReNeroArroccoCorto = Scacchiera.getCella(settimaColonna, ottavaTraversa);
	Cella cellaCorrettaDestinazioneTorreNeraDxArroccoCorto = Scacchiera.getCella(sestaColonna, ottavaTraversa);
	
	Turno.cambioTurno(); // Imposto il turno al giocatore nero
	assertFalse(
	...
	Cella cella_temp = new Cella(coordXinizialeReNero - 1, coordYinizialeReNero + 1, 
		Scacchiera.getCella(coordXinizialeReNero - 1, coordYinizialeReNero + 1).getPezzoCorrente());

	Cella cella_d2 = Scacchiera.getCella(coordXinizialeReBianco - 1, coordYinizialeReBianco - 1);
	Cella cella_d7 = Scacchiera.getCella(coordXinizialeReNero - 1, coordYinizialeReNero + 1);
	...
	Scacchiera.getCella(coordXinizialeReBianco - 3, coordYinizialeReBianco).rimuoviPezzoCorrente();
	
	Cella cellaCorrettaDestinazioneReBiancoArroccoLungo = Scacchiera.getCella(terzaColonna, primaTraversa);
	Cella cellaCorrettaDestinazioneTorreBiancaArroccoLungo = Scacchiera.getCella(quartaColonna, primaTraversa);
	...
	assertEquals(Re.convertiMossa("Rxe1"), "a0 a0");
    }
	...
	assertEquals(Re.convertiMossa("Rxe2"), "a0 a0"); // Cattura su casa occupata da pedone stesso colore
    }

    @Test
    final void testConvertiMossaAvanzataBiancoCasaLibera() {
	
	Scacchiera.getCella(ottavaColonna, secondaTraversa).rimuoviPezzoCorrente();

	Cella cella_h1 = Scacchiera.getCella(ottavaColonna, primaTraversa);
   	Scacchiera.scambiaCella(posizioneInizialeReBianco, cella_h1);
	...
	Cella cella_e2 = Scacchiera.getCella(coordXinizialeReNero, coordYinizialeReBianco - 1);
	 ...
	 */
   	...
   	Cella cella_e2 = Scacchiera.getCella(coordXinizialeReBianco, coordYinizialeReBianco - 1);
   	cella_e2.rimuoviPezzoCorrente();
