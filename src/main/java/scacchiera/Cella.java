 ...
 * 
 * La classe Cella Ë di tipo ENTITY
 */
public final class Cella {
	private int x;
	private int y;
	private boolean occupato; //TODO: lo stato occupato si pu√≤ ottenere dalla cella, se contiene un pezzo o meno. Si potrebbe pensare di eliminare questa variabile
